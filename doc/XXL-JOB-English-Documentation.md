...
The location of log file can be specified in executor configuration file, default pattern is : /home/work/logs/xxl-job/jobhandler/formatted date/primary key for database scheduling log records.log”.
